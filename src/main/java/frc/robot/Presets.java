...
public class Presets {
    ...
    public static final class Climber {
        public static final Rotation2d CLIMB_PREP_POS = Rotation2d.fromDegrees(0);
        public static final Rotation2d CLIMB_POS = Rotation2d.fromDegrees(0);
        public static final Rotation2d TRAP_POS = Rotation2d.fromDegrees(0);

        public static final Rotation2d POS_TOLERANCE = Rotation2d.fromDegrees(0);
