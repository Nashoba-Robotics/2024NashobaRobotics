...
public class AimToStation extends Command{
    ...
    public AimToStation(DriveSubsystem drive, JoystickSubsystem joysticks){
    ...
    public boolean isFinished() {
        ...
        return Governor.getRobotState() != RobotState.SHUTTLE_HIGH_ADJ 
        && Governor.getRobotState() != RobotState.SHUTTLE_LOW_ADJ && Governor.getRobotState() != RobotState.TRANSITION
