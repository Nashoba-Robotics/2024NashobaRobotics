...
public class OnTheFlytoPathCommand extends SequentialCommandGroup {
    
    public OnTheFlytoPathCommand() {
        // Load the path we want to pathfind to and follow
        PathPlannerPath path = PathPlannerPath.fromPathFile("OnTheFlyTest");
